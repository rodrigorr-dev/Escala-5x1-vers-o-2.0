...
const EmployeeListPage: React.FC = () => {
  ...
  const employeesConfig: ExtendedEmployee[] = [
    ...
    { id: '4', name: 'Valci Jacinto', role: 'Líder Mecânico', avatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&h=150&fit=crop', status: EmployeeStatus.AVAILABLE, referenceDate: new Date(2025, 11, 1), rotation: 'SundayOff' },
